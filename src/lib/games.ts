...
export const games: Game[] = [
  {
    ...
    description: 'A sequence of numbers is required. Four digits will unlock it. The solution is hidden in plain sight, think about the year this journey began.',
